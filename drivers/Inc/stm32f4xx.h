...
/*
 * clock enable or disable - RCC
 */
#define RCC_ADDR       0x4002 3800U //<!RCC start address - clock>
/*
 * base address for the Internal memories
 */
#define FLASH_ADDR  0x0800 0000U  //<!Flash start address>

#define SRAM1_ADDR 0x2000 0000U  //<!SRAM1 start address>

#define SRAM2_ADDR 0x2001 C000U //<!SRAM2 start address>

#define ROM_ADDR      0x1FFF 0000   // <!ROM start address>

/*
 * base address of the Buses - APB & AHB bus in ARM M controllers
 */
#define PERIPH_BASE_ADDR      			0x4000 0000U          		//<!Peripheral base address>
